...
class AnchorBoxes(Layer):
    ...
    def call(self, x, mask=None):
        ...
        batch_size, feature_map_channels, feature_map_height, feature_map_width = batch_size.value, feature_map_channels.value, feature_map_height.value, feature_map_width.value
